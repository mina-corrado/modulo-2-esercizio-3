...
if (a>b && a>c) {
  if (b>c) {
    console.log(`risultato ordinamento numeri dal più alto al più basso: a = ${a}, b = ${b}, c=${c} `);
  } else {
    console.log(`risultato ordinamento numeri dal più alto al più basso: a = ${a}, c=${c}, b = ${b} `);
  }
} else if (b>a && b>c) {
  if (a>c) {
    console.log(`risultato ordinamento numeri dal più alto al più basso: b = ${b}, a = ${a}, c=${c} `);
  } else {
    console.log(`risultato ordinamento numeri dal più alto al più basso: b = ${b}, c=${c}, a = ${a} `);
  }
} else if (c>a && c>b) {
  if (a>b) {
    console.log(`risultato ordinamento numeri dal più alto al più basso: c = ${c}, a = ${a}, b=${b} `);
  } else {
    console.log(`risultato ordinamento numeri dal più alto al più basso: c = ${c}, b=${b}, a = ${a} `);
  }
}
